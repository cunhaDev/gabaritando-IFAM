...
//questão 2
	...
	for(x=0;x<y;x++){
		if ( document.quest.opcao3[x].checked ) {
			ok="S";
			if(document.quest.opcao3[x].value=='C'){
				notas=notas+1;
			}
		}
	}
	...
	for(x=0;x<y;x++){
		if ( document.quest.opcao4[x].checked ) {
			ok="S";
			if(document.quest.opcao4[x].value=='A'){
				notas=notas+1;
			}
		}
	}
	...
	for(x=0;x<y;x++){
		if ( document.quest.opcao7[x].checked ) {
			ok="S";
			if(document.quest.opcao7[x].value=='C'){
				notas=notas+1;
			}
		}
	}
	...
	for(x=0;x<y;x++){
		if ( document.quest.opcao8[x].checked ) {
			ok="S";
			if(document.quest.opcao8[x].value=='C'){
				notas=notas+1;
			}
		}
	}
	...
	for(x=0;x<y;x++){
		if ( document.quest.opcao9[x].checked ) {
			ok="S";
			if(document.quest.opcao9[x].value=='C'){
				notas=notas+1;
			}
		}
	}
	if (ok=="N") {
		window.alert("Falta responder a questão 9.");
		return false;
	}
	...
	for(x=0;x<y;x++){
		if ( document.quest.opcao10[x].checked ) {
			ok="S";
			if(document.quest.opcao10[x].value=='A'){
				notas=notas+1;
			}
		}
	}
...
function validarAutomatico(){
	...
	//questão 2
	  ...
	  //questão 3
		...
		for(x=0;x<y;x++){
			if (document.quest.opcao6[x].checked ) {
				if(document.quest.opcao6[x].value=='C'){
					notas=notas+1;
				}
			}
		}
		...
		for(x=0;x<y;x++){
			if (document.quest.opcao9[x].checked ) {
				if(document.quest.opcao9[x].value=='B'){
					notas=notas+1;
				}
			}
		}
