...
//questão 1
	...
	for(x=0;x<y;x++){
		if (document.quest.opcao1[x].checked ) {
			ok="S";
			if(document.quest.opcao1[x].value=='A'){
				notas=notas+1;
			}
		}
	}
...
//questão 2
	...
	for(x=0;x<y;x++){
		if ( document.quest.opcao2[x].checked ) {
			ok="S";
			if(document.quest.opcao2[x].value=='A'){
				notas=notas+1;
			}
		}
	}
	...
	for(x=0;x<y;x++){
		if ( document.quest.opcao3[x].checked ) {
			ok="S";
			if(document.quest.opcao3[x].value=='A'){
				notas=notas+1;
			}
		}
	}
	...
	for(x=0;x<y;x++){
		if ( document.quest.opcao6[x].checked ) {
			ok="S";
			if(document.quest.opcao6[x].value=='A'){
				notas=notas+1;
			}
		}
	}
	...
	for(x=0;x<y;x++){
		if ( document.quest.opcao7[x].checked ) {
			ok="S";
			if(document.quest.opcao7[x].value=='A'){
				notas=notas+1;
			}
		}
	}
	...
	for(x=0;x<y;x++){
		if ( document.quest.opcao8[x].checked ) {
			ok="S";
			if(document.quest.opcao8[x].value=='A'){
				notas=notas+1;
			}
		}
	}
